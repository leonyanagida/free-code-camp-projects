  ...
  var myObj = function(name, url, logo, desc) {
        ...
        this.showOnline = function() {
          ...
          */
          htmlTxt = '<a href="' + url + '"' +
          ' target="_blank" id="txthover"><li class="online def"><i class="fa fa-circle fa-2x" aria-hidden="true"></i><div class="username"><h2>' + name +
          '</h2></div><img src="' + logo + '"' +
        ...
        this.showOffline = function() {
          ...
          */
          ...
          htmlTxt = '<a href="' + url + '"' +
          ' target="_blank" id="txthover"><li class="offline def"><i class="fa fa-circle fa-2x redcircle" aria-hidden="true"></i><div class="username"><h2>' + name +
          '</h2></div><img src="' + logo + '"' +
